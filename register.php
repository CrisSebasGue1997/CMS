...
if(isset($_POST['register'])){
    ...
    'email'=>$_POST['email'],
    'password'=>md5($_POST['password']) #metodo de incriptacion
];

$usuario ->saveUser($data);
}
?>
                ...
                <div class="container-form">
                    ...
                    <form action="#" method="POST" name="registerForm" id="registerForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg">
                                <div class="form-group">
                                    <input type="text" id="subname" name="subname" class="form-control" required>
                                    <label for="subname" class="form-label">Apodo</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-lg-center">
                            <button type="submit" name="register" id="register" class="btn btn-signup--register align-self-center">Aceptar</button>
                        </div>
